...
%         Butterworth filter
        ...
        figure(1)
        plot(t,y_flex,'g',t,z_flex,'r'); 
        xlabel('Time after stretch (s)','FontSize', 16); ylabel('EMG (mV)','FontSize', 16); 
        legend('Rectified','Linear envelope','Location','best','FontSize', 16); 
...
%         subplot(2,1,1)
        ...
        xlabel('Time after stretch (s)','FontSize', 16); ylabel('EMG (mV)','FontSize', 16); 
        legend('Sliding window 50ms','Sliding window 25ms','Location','best','FontSize', 16); 
